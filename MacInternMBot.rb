    ...
    case message.text
    	...
    	when '/alive'
    		if message.from.username == USER
      			...
      			bot.api.send_message(chat_id: message.chat.id, text: "Hi @#{message.from.username}, I am @#{USER}'s mac bot, not yours. :) If you want to set up your mac bot, contact #{USER}@gmail.com");
      		end
      	when '/sleep'
    		if message.from.username == USER
      	...
      	when '/'
     		if message.from.username == USER
     			...
     			bot.api.send_message(chat_id: message.chat.id, text: "Hi @#{message.from.username}, I am @#{USER}'s bot. He uses me for remotely controlling his mac.");
     		end
